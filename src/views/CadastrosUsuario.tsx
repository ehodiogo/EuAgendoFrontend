...
import { FaBuilding, FaUserTie, FaList, FaLink, FaCalendar, FaDatabase, FaArrowRight, FaArrowDown } from "react-icons/fa6"; // Usando Fa6 para consistência
import { FaCog, FaTools } from "react-icons/fa"; // ✅ certo
    ...
    <div className="min-vh-100">
      ...
      <div className="custom-bg min-vh-100">
        ...
        <div className="cadastros-container container">
          ...
          <p className="lead">
            Crie, edite e organize a base de dados do seu sistema: Empresas, Funcionários e Serviços.
          </p>
          ...
          <div className="info-grid">
            ...
            {/* CARD 1: FLUXO PARA CADASTRO CORRETO */}
            <div className="info-card fluxo-section">
              ...
              <ul>
                <li>
                  ...
                  <strong>1. Empresa:</strong> Crie a empresa (dados, horários de funcionamento e intervalos).
                </li>
                <li>
                  <FaUserTie className="step-icon text-warning-orange" />
                  <strong>2. Funcionário:</strong> Adicione funcionários e associe-os à empresa que você acabou de criar.
                </li>
                <li>
                  <FaTools className="step-icon text-success-green" />
                  <strong>3. Serviço:</strong> Cadastre os serviços e associe-os aos funcionários que irão realizá-los.
                </li>
                <li style={{borderTop: '1px dashed var(--border-light)', paddingTop: '10px', marginTop: '10px'}}>
                  ...
                  <strong>Resultado:</strong> Com os dados configurados, os clientes poderão agendar horários, selecionando Empresa → Funcionário → Serviço.
                </li>
              </ul>
            </div>

            {/* CARD 2: RELAÇÃO HIERÁRQUICA */}
            <div className="info-card relacao-section" style={{borderLeftColor: 'var(--success-green)'}}>
              <h3>
              ...
              <pre>
                ...
                <span className="relacao-line">&nbsp;&nbsp;<FaArrowDown size={14} /></span>
                <span className="relacao-line">&nbsp;&nbsp;↳ <FaUserTie /> Funcionários (Muitos)</span>
                <span className="relacao-line">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<FaArrowDown size={14} /></span>
                <span className="relacao-line">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↳ <FaTools /> Serviços (Muitos para Cada Funcionário)</span>
              </pre>
              <p className="fw-semibold text-dark-gray">
                <FaList className="text-accent-blue"/> <strong>Cada Funcionário possui sua própria lista de Serviços</strong> que ele está apto a realizar.
              </p>
            </div>
          </div>
        </div>
